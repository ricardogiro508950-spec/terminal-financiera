...
@app.route('/')
def home():
    return "🟢 Motor Oculoos Simulación Activo."
...
def obtener_ultimo_capital():
    """Recupera el último capital acumulado del CSV para mantener el interés compuesto."""
