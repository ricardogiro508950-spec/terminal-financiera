...
# ✅ AHORA CON 3 ACTIVOS: ORO, BITCOIN Y PETRÓLEO
...
app = Flask(__name__)
@app.route('/')
def home(): return "🟢 Laboratorio de Estrés Cuántico Activo (3 Activos)"
...
def analizar_mercado_con_sensibilidad(ticker, version):
    ...
    if "V2" in version or "V8" in version:
        ...
        elif "Agresiva" in version or "Ultra-Sensible" in version:
            condicion_vela = True
            multiplicador_vol = 0.5
        else:
...
if __name__ == '__main__':
    ...
    enviar_alerta("🧪 *LABORATORIO DE ESTRÉS CUÁNTICO INICIADO*\nActivos: Oro, Bitcoin y Petróleo.\n8 Estrategias compitiendo.")
